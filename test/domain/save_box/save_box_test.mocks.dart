...
// in flutter_to_do/test/domain/save_box/save_box_test.dart.
...
import 'save_box_test.dart' as _i4;
...
class _FakeIsar_1 extends _i1.SmartFake implements _i2.Isar {
  _FakeIsar_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockIsar extends _i1.Mock implements _i2.Isar {
  ...
  _i3.Future<T> writeTxn<T>(
    ...
    bool? silent = false,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i4.writeTxnX<T>(
          callback,
          silent: silent,
        ),
        returnValueForMissingStub: _i4.writeTxnX<T>(
          callback,
          silent: silent,
        ),
      ) as _i3.Future<T>);
  ...
  T txnSync<T>(T Function()? callback) => (super.noSuchMethod(
        ...
        returnValue: _i4.txnSyncX<T>(callback),
        returnValueForMissingStub: _i4.txnSyncX<T>(callback),
      ) as T);
  @override
  T writeTxnSync<T>(
    T Function()? callback, {
    bool? silent = false,
      ...
      (super.noSuchMethod(
        ...
        returnValue: _i4.writeTxnSyncX<T>(
          callback,
          silent: silent,
        ),
        returnValueForMissingStub: _i4.writeTxnSyncX<T>(
          callback,
          silent: silent,
        ),
      ) as T);
...
class MockIsarCollection<OBJ> extends _i1.Mock
  ...
  _i2.CollectionSchema<OBJ> get schema => (super.noSuchMethod(
        ...
        returnValueForMissingStub: _FakeCollectionSchema_2<OBJ>(
          this,
          Invocation.getter(#schema),
        ),
  ...
  @override
  _i3.Future<void> importJsonRaw(_i5.Uint8List? jsonBytes) =>
      (super.noSuchMethod(
        Invocation.method(
          #importJsonRaw,
          [jsonBytes],
  ...
  _i2.QueryBuilder<OBJ, OBJ, _i2.QWhere> where({
    ...
    _i2.Sort? sort = _i2.Sort.asc,
      ...
      (super.noSuchMethod(
        ...
        returnValueForMissingStub: _FakeQueryBuilder_3<OBJ, OBJ, _i2.QWhere>(
          this,
          Invocation.method(
            #where,
            [],
  ...
  _i2.QueryBuilder<OBJ, OBJ, _i2.QFilterCondition> filter() =>
      (super.noSuchMethod(
        ...
        returnValueForMissingStub:
            _FakeQueryBuilder_3<OBJ, OBJ, _i2.QFilterCondition>(
          this,
          Invocation.method(
            #filter,
            [],
