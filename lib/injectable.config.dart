...
import 'package:flutter_to_do/application/landing_page/landing_page_bloc.dart'
    as _i7;
import 'package:flutter_to_do/application/task_page/task_page_bloc.dart' as _i9;
...
import 'package:flutter_to_do/infrastructure/data_source/dummy_datasource.dart'
    as _i3;
import 'package:flutter_to_do/infrastructure/data_source/save_box.dart' as _i8;
...
Future<_i1.GetIt> init(
  ...
  gh.lazySingleton<_i4.ITaskRepository>(
      () => _i5.TaskRepository(gh<_i3.DummyDatasource>()));
  await gh.singletonAsync<_i6.Isar>(
    () => registerModule.isar,
    preResolve: true,
  );
  gh.lazySingleton<_i7.LandingPageBloc>(() => _i7.LandingPageBloc());
  gh.lazySingleton<_i8.SaveBox>(() => _i8.SaveBoxImpl(gh<_i6.Isar>()));
  gh.lazySingleton<_i9.TaskPageBloc>(
      () => _i9.TaskPageBloc(gh<_i4.ITaskRepository>()));
  gh.lazySingleton<_i10.IPrefsRepository>(
      () => _i11.PrefsRepository(gh<_i8.SaveBox>()));
  gh.factory<_i12.ThemeBloc>(() => _i12.ThemeBloc(gh<_i10.IPrefsRepository>()));
  return getIt;
}
